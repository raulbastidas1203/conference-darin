...
| `humanoidcat2025` | Learning Humanoid Loco-manipulation with Constraints as Terminations | Leziart P-A., Morisawa M., Kanehiro F. | IEEE Humanoids 2025 | Conference | Central | Paywall | FULL-TEXT | Unread | PDF in /papers/; package transport with stability constraints |
